function founderr=runFrameAnalysis
	...
	state.analysis.roiFluorData=cell(1, state.imaging.daq.maximumNumberOfInputChannels+10);
	state.analysis.roiBaseLines=cell(1, state.imaging.daq.maximumNumberOfInputChannels+10);
	state.analysis.roiScanMeans=cell(1, state.imaging.daq.maximumNumberOfInputChannels+10);

	analyzedChannels=zeros(1,state.imaging.daq.maximumNumberOfInputChannels);
	for channel=1:state.imaging.daq.maximumNumberOfInputChannels
