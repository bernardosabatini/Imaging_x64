function runFluorAnalysis(acqNumber)
	...
	state.analysis.roiBaseline=cell(1, state.imaging.daq.maximumNumberOfInputChannels+10);
	state.analysis.roiMean=cell(1, state.imaging.daq.maximumNumberOfInputChannels+10);
	state.analysis.roiPeak=cell(1, state.imaging.daq.maximumNumberOfInputChannels+10);
	...
	state.analysis.roiBaselineR=cell(1, state.imaging.daq.maximumNumberOfInputChannels+10);
	for channel=state.analysis.analyzedChannels
		for roiCounter=nROI
	...
	if ~state.analysis.keepInMemory
	 	for channel=[1:state.imaging.daq.maximumNumberOfInputChannels 11:(state.imaging.daq.maximumNumberOfInputChannels+10)]
			for roiCounter=nROI
