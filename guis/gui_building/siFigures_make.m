function siFigures_make
    ...
    state.imaging.internal.maxAxisHandle=cell(length(channelList), 1);
    state.imaging.internal.maxImageHandle=cell(length(channelList), 1);
	...
	for channelCounter = channelList
      ...
      state.imaging.internal.maxAxisHandle{channelCounter, 1} = ...
            axes(...
            'YDir', 'Reverse', ...
            'NextPlot', 'add', ...
        ...
        state.imaging.internal.maxImageHandle{channelCounter, 1} = ...
            image(...
            int16(zeros(state.acq.linesPerFrame, state.acq.pixelsPerLine)), ...
            'CDataMapping', 'Scaled', ...
            'Parent', state.imaging.internal.maxAxisHandle{channelCounter, 1}, ...
            'ButtonDownFcn', 'figureButtonOverCallback'...
            );
