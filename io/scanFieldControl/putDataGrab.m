function putDataGrab
    ...
    if length(state.cycle.physiologyOnList)>=state.cycle.currentCyclePosition & state.cycle.physiologyOnList(state.cycle.currentCyclePosition) % BSMOD 08012005 Changes so that Imaging and Phys can both use the aux board
                                                                                                                                   %TN 03Aug05
